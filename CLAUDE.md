...
| `wiki/`      | Requirements (`requirements.md`), architecture spine (`architecture.md` — paradigm/stack/structural seed/data model) plus binding invariants (`architecture-invariants.md` — AD-1..AD-15), story catalogue (`stories/`), and module-scoped tasks (`tasks/`). |
